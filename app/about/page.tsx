        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-4 gap-4 mb-20 overflow-x-auto">
            {teamMembers.map((member, index) => (
              <div
                key={index}
                className="border border-border rounded-lg overflow-hidden bg-card hover:shadow-xl transition-shadow duration-300 min-w-0 flex-shrink-0"
              >
                {/* Image Section */}
                ...
                <div className="p-4">
                  ...
                  <div className="mb-2">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {member.languages.map((lang, idx) => (
                        <span key={idx} className="px-2 py-0.5 bg-accent text-accent-foreground text-[10px] rounded-full whitespace-nowrap">
                          {lang}
                        </span>
                      ))}
                    </div>
                  ...
                  <a href={member.calendlyUrl} target="_blank" rel="noopener noreferrer">
                    <Button size="sm" className="w-full bg-primary hover:bg-accent text-primary-foreground text-xs py-1.5">
