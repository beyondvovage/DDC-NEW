    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative py-20 md:py-32 px-4 md:px-8 bg-muted/30">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-balance">Deep Dive Hangzhou</h1>
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-8 text-balance">
            Discover the poetic beauty and rich tea culture of one of China's most scenic cities
          </p>
          <Link href="/book">
