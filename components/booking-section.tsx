...
export function BookingSection() {
  return (
    <section id="booking-section" className="py-20 md:py-32 px-4 md:px-8 bg-muted/30">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-4xl md:text-5xl font-bold mb-12 text-center">Book Your Experience</h2>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Left Side - Video Consultation */}
          <div className="bg-background border border-border rounded-lg shadow-lg overflow-hidden">
            <div className="p-6 md:p-8">
              <h3 className="text-2xl md:text-3xl font-bold mb-4 text-center">15-Minute Consultation</h3>
          ...
          <div className="bg-background border border-border rounded-lg shadow-lg overflow-hidden">
            <div className="p-6 md:p-8">
              <h3 className="text-2xl md:text-3xl font-bold mb-4 text-center">Booking Form</h3>
              <p className="text-center text-muted-foreground mb-6">
